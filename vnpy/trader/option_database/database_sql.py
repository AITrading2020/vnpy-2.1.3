...
def init_models(db: Database, driver: Driver):
    class DbBarData(ModelBase):
        ...
        vix = FloatField(null=True)
        rv = FloatField(null=True)
...
class SqlManager(BaseDatabaseManager):
    ...
    def load_bar_data(
        ...
        data = [db_bar.to_bar(columns) for db_bar in s]
        return data
    ...
    def get_newest_bar_data(
            self, symbol: str, exchange: "Exchange", interval: "Interval", columns=None,
    ) -> Optional["BarData"]:
        s = (
